...
function AccordionTrigger({
  ...
  return (
    <AccordionPrimitive.Header className="flex">
      ...
      >
        {children}
        <ChevronDown data-slot="accordion-trigger-icon" className="pointer-events-none size-4 shrink-0 group-aria-expanded/accordion-trigger:hidden" aria-hidden />
        <ChevronUp data-slot="accordion-trigger-icon" className="pointer-events-none hidden size-4 shrink-0 group-aria-expanded/accordion-trigger:inline" aria-hidden />
      </AccordionPrimitive.Trigger>
