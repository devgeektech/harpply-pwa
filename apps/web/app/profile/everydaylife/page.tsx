...
function EverydayIconTile(
  ...
  return (
    <div
      className={cn(
        "flex shrink-0 items-center justify-center rounded-md bg-[linear-gradient(145deg,rgba(200,168,81,0.16)_0%,rgba(35,22,58,0.92)_55%,rgba(18,10,38,0.96)_100%)] text-[#d4a84b] shadow-[inset_0_1px_0_rgba(255,255,255,0.07)]",
        box,
      )}
    >
                ...
                >
                  ...
                  >
                    ...
                    <span className="shrink-0">
                      {isOpen ? (
                        <ChevronUp
                          className="size-5 text-[#C8A851]/90"
                          strokeWidth={2}
                          aria-hidden
                        />
                      ) : (
                        <ChevronDown
                          className="size-5 text-[#a89bc4]/90"
                          strokeWidth={2}
                          aria-hidden
                        />
                      )}
