        ...
        <div className="items-center gap-3 ms-3 me-4 flex">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent className="mt-[12px] border-white/10 bg-gradient-to-b from-[rgba(100, 28, 60, 0.296)] to-[rgba(7, 1, 26, 0.74)]">
              ...
              {/* <DropdownMenuSeparator  className="bg-white/10" /> */}
              <DropdownMenuItem asChild><Link href="/profile/identity" className="cursor-pointer text-sm font-medium text-[#C39936]"><CircleUserRound className="text-[#C39936]" /> Profile</Link></DropdownMenuItem>
              <DropdownMenuSeparator className="bg-white/10" />
