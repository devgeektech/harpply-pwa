...
export function AdminSidebar({
  ...
  return (
    <aside className="w-[260px] hidden md:flex flex-col border-r border-white/10 bg-white/5 backdrop-blur-xl">
        ...
        {nav.map((item) => {
          ...
          return (
            <button
              ...
              className={[
                "cursor-pointer w-full flex items-center gap-3 px-3 py-3 rounded-xl text-left transition",
                isActive
